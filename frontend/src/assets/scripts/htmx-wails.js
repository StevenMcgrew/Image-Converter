...
(function (root, factory) {
    ...
    return (function () {
        ...
        var VERBS = ['get', 'post', 'put', 'delete', 'patch', 'func'];
        ...
        async function issueAjaxRequest(verb, path, elt, event, etc, confirmed) {
            var resolve = null;
            var reject = null;
            etc = etc != null ? etc : {};
            ...
            if (verb === 'func') {
                try {
                    responseInfo.myResponse = await htmx.myFunctions[path](filteredParameters);
                    ...
                    triggerErrorEvent(elt, 'htmx:onLoadError', mergeObjects({ error: err }, responseInfo));
                    console.error(`An error occured when calling htmx.myFunctions['${path}']():  `, err);
                    throw err;
                }
            }
            else {
        ...
        function handleAjaxResponse(elt, responseInfo) {
            ...
            // myCode
            //
            if (responseInfo.requestConfig.verb === 'func') {
                shouldSwap = true;
                serverResponse = responseInfo.myResponse;
            }
            //
            //
            //
